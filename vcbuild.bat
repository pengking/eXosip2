...
"%PYTHON%" all.py -Dtarget_arch=%target_arch% -Duv_library=%library% --generator-output=./Build
if errorlevel 1 goto create-msvs-files-failed
if not exist ./Build/all.sln goto create-msvs-files-failed
...
:msbuild-found
msbuild ./Build/all.sln /t:%target% /p:Configuration=Debug /p:Platform=%platform% /clp:NoSummary;NoItemAndPropertyList;Verbosity=minimal /nologo
